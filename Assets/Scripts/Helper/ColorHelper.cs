...
namespace NFramework
{
    public static class ColorHelper
    {
        ...
        /// </summary>
        public static Color GetRandomColor(Color color, Color min, Color max)
        {
            return new Color
            {
        ...
        /// <summary>
        /// Brightness offset with 1 is brighter and -1 is darker
        /// </summary>
        public static Color GetColorWithBrightnessOffset(Color color, float offset)
        {
            return new Color(
                color.r + offset,
                color.g + offset,
        ...
        public static Color Colorize(Color originalColor, Color targetColor, ColoringMode coloringMode, float lerpAmount = 1.0f)
        {
