...
namespace NFramework
{
    public static class VectorHelper
    {
        ...
        /// </summary>
        public static Vector2 GetRandomDirVector2() => RandomVector(Vector2.zero, Vector2.one).normalized;

        /// <summary>
        /// Returns a normalized random  direction (3D).
        /// </summary>
        public static Vector3 GetRandomDirVector3() => RandomVector(Vector3.zero, Vector3.one).normalized;
